...
This happened with [Engramma](https://app.engramma.dev), my tool for editing
JSON with design tokens. No phishing, no malware, only anonymous analytics.

## What Is Engramma?

I built [Engramma](https://app.engramma.dev) to explore better approaches for
...
[Google Safe Browsing](https://transparencyreport.google.com), created an
account at [Google Search Console](https://search.google.com/search-console),
...
on [VirusTotal](https://virustotal.com/) showed **10 different security
...
[engramma.dev](https://engramma.dev) domain. Good thing there are many other
channels to share.
